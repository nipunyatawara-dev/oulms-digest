...
export function Header({
  ...
  return (
    <>
      <header className="w-full bg-[#fbf8f5] px-4 sm:px-8 lg:px-10 py-2.5 sm:py-4 flex items-center justify-between transition-all select-none border-b border-[#4e080c]/[0.06] ios-safe-top sticky top-0 z-30 backdrop-blur-sm bg-[#fbf8f5]/95">
        ...
        <div className="flex items-center gap-2 sm:gap-2.5 text-[13px]">
          ...
          <button
            ...
            className={`md:hidden relative min-w-[44px] min-h-[44px] flex items-center justify-center rounded-xl border transition-all active:scale-95 ${
              activeView === 'Announcements'
                ...
                : 'bg-white text-[#4e080c] border-[#4e080c]/[0.12] shadow-refero-sm hover:bg-[#f5efe9]'
            }`}
            ...
            {announcementsCount > 0 && (
              <span
                className={`absolute -top-1 -right-1 min-w-[16px] h-[16px] px-1 text-[9.5px] rounded-full flex items-center justify-center font-bold shadow-refero-sm ${
                  activeView === 'Announcements' ? 'bg-white text-[#4e080c]' : 'bg-[#4e080c] text-white'
                }`}
              >
          ...
          {onOpenSchedule && (
            <button
              ...
              className="hidden md:inline-flex items-center justify-center gap-1.5 px-3 py-2 text-[13px] font-medium text-[#4e080c] bg-white hover:bg-[#f5efe9] border border-[#4e080c]/[0.12] rounded-lg shadow-refero-sm active:scale-[0.98] transition-all min-h-[44px] min-w-[44px]"
          ...
          {/* Mobile Profile & Settings Menu Avatar Button */}
          <button
            onClick={() => setIsMobileMenuOpen(true)}
            className="md:hidden min-w-[44px] min-h-[44px] flex items-center justify-center rounded-xl bg-white text-[#4e080c] border border-[#4e080c]/[0.12] shadow-refero-sm hover:bg-[#f5efe9] active:bg-[#ede3da] active:scale-95 transition-all relative"
            aria-label="Account Settings & Menu"
            title="Account Settings & Menu"
          >
            <User className="w-4 h-4 text-[#4e080c]" />
            {studentUsername && (
      ...
      {isMobileMenuOpen && (
        <div className="fixed inset-0 z-50 flex items-end justify-center bg-black/40 backdrop-blur-xs select-none md:hidden">
          {/* Backdrop click to dismiss */}
          <div className="fixed inset-0" onClick={() => setIsMobileMenuOpen(false)} />

          <div className="relative w-full bg-[#fbf8f5] rounded-t-3xl border-t border-[#4e080c]/[0.12] shadow-refero-lg overflow-hidden p-5 sm:p-6 ios-safe-bottom animate-slide-in-up z-10 space-y-4">
            {/* Grabber Bar */}
            <div className="w-10 h-1 bg-[#4e080c]/20 rounded-full mx-auto mb-2" />

            {/* User Profile Header Card */}
            <div className="p-4 rounded-2xl bg-[#f2ebe5] border border-[#4e080c]/[0.06] flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="font-semibold text-[#4e080c] text-[14.5px]">
                    {displayStudent}
                  </div>
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="p-2.5 rounded-xl bg-white border border-[#4e080c]/[0.08] text-[#71717A] hover:text-[#4e080c] transition-colors"
            ...
            <div className="space-y-2">
              ...
              <button
                ...
                className="w-full flex items-center justify-between p-3.5 rounded-2xl bg-white hover:bg-[#f5efe9] active:bg-[#ede3da] border border-[#4e080c]/[0.08] text-left transition-all min-h-[50px] active:scale-[0.98]"
              >
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded-lg bg-[#4e080c]/[0.05] text-[#4e080c] flex items-center justify-center">
                    <Key className="w-4 h-4" />
                  </div>
                  <div>
                    <div className="text-[13.5px] font-semibold text-[#4e080c]">
                      Account Credentials & IAM
                    </div>
            ...
            <div className="pt-2">
              <button
                ...
                className="w-full py-3 rounded-2xl bg-[#4e080c]/[0.08] hover:bg-[#4e080c]/[0.12] active:bg-[#4e080c]/[0.18] text-[#4e080c] font-semibold text-[13.5px] transition-all min-h-[44px]"
              >
                Close Menu
              </button>
            </div>
